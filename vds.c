...
/* ----------------------------------------------------------------------- */
void calcthetadotdot(double slewmax, double gradmax, double kr, double krdot, double Tgsample, double Tdsample, int Ninterleaves, double *fov, int numfov, double *thetadotdot, double *krdotdot)
/*
...
calc_vds(12000.0*0.99, 3.267, 0.000002/10, 0.000002, 1, fov, 1, 192.0/(2.0*fov[0]), 1048576, &gx, &gy, &ng); 
