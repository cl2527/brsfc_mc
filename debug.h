...
#define fshowll(fp, a) FPRINTSTR(fp,a,%lld)
...
#define showll(a) fshowll(stdout,a)
...
#define fshowarrll(fp, a, n) FPRINTARRSTR(fp,a,%lld,n)
...
#define showarrll(a, n) fshowarrll(stdout,a,n)
...
#ifdef PSD_HW
#define DEBUGFILE(N) stringize(/tmp/N)
#else
#define DEBUGFILE(N) stringize(N)
#endif
